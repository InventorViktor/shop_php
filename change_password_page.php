...
<div class="container">
    ...
    <main>
        ...
        <h1 class="text-center h3">Podaj nowe hasło</h1>

        <?php
        if(isset($_SESSION['new_password'])){

            echo "<div class='text-success text-center bigText'>{$_SESSION['new_password']}</div>";
            unset($_SESSION['new_password']);
        }
        ?>

        <form style="max-width: 400px; margin: auto;" method="post" action="change_password.php" >


            <input name="new_password" type="password" class="form-control mt-5" required autofocus>
